...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class PlacesDB : Persistent
	{
		#region ATRIBUTOS
		...
		*/
		...
		public PlacesModel Load(Int64 PlaceId)
		{
			try
			{				
		...
		/// <returns>List<Places></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<PlacesModel> SelectBy_UserId(Int64 UserId)
		{
			try
			{
				List<PlacesModel> lt = new List<PlacesModel>();
				DataTable dt = new DataTable();
				...
				for (int i=0;i<dt.Rows.Count;i++)
				{
					PlacesModel obj = new PlacesModel();
		...
		/// <returns>List<Places></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<PlacesModel> SelectBy_UserId_Pages(Int64 UserId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<PlacesModel> lt = new List<PlacesModel>();
