...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class TrackUsersEvents : Persistent
	{
		#region ATRIBUTOS
		...
		*/
		...
		public TrackUsersEvents Load(Int64 UserId, Int64 EventId)
		{
			try
			{				
		...
		/// <returns>List<TrackUsersEvents></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersEvents> SelectBy_UserId(Int64 UserId)
		{
			try
			{
				List<TrackUsersEvents> lt = new List<TrackUsersEvents>();
				...
				for (int i=0;i<dt.Rows.Count;i++)
				{
					TrackUsersEvents obj = new TrackUsersEvents();
		...
		/// <returns>List<TrackUsersEvents></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersEvents> SelectBy_UserId_Pages(Int64 UserId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<TrackUsersEvents> lt = new List<TrackUsersEvents>();
		...
		/// <returns>List<TrackUsersEvents></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersEvents> SelectBy_EventId(Int64 EventId)
		{
			try
			{
				List<TrackUsersEvents> lt = new List<TrackUsersEvents>();
		...
		/// <returns>List<TrackUsersEvents></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersEvents> SelectBy_EventId_Pages(Int64 EventId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<TrackUsersEvents> lt = new List<TrackUsersEvents>();
