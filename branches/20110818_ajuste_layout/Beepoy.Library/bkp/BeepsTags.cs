...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class BeepsTags : Persistent
	{
		#region ATRIBUTOS
		...
		*/
		...
		public BeepsTags Load(Int64 BeepId, Int64 TagId)
		{
			try
			{				
		...
		/// <returns>List<BeepsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<BeepsTags> SelectBy_BeepId(Int64 BeepId)
		{
			try
			{
				List<BeepsTags> lt = new List<BeepsTags>();
		...
		/// <returns>List<BeepsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<BeepsTags> SelectBy_BeepId_Pages(Int64 BeepId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<BeepsTags> lt = new List<BeepsTags>();
		...
		/// <returns>List<BeepsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<BeepsTags> SelectBy_TagId(Int64 TagId)
		{
			try
			{
				List<BeepsTags> lt = new List<BeepsTags>();
		...
		/// <returns>List<BeepsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<BeepsTags> SelectBy_TagId_Pages(Int64 TagId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<BeepsTags> lt = new List<BeepsTags>();
