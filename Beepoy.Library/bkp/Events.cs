...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class Events : Persistent
	{
		#region ATRIBUTOS
		...
		*/
		...
		public Events Load(Int64 EventId)
		{
			try
			{				
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_PlaceId(Int64 PlaceId)
		{
			try
			{
				List<Events> lt = new List<Events>();
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_PlaceId_Pages(Int64 PlaceId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<Events> lt = new List<Events>();
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_TimeId(Int64 TimeId)
		{
			try
			{
				List<Events> lt = new List<Events>();
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_TimeId_Pages(Int64 TimeId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<Events> lt = new List<Events>();
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_UserId(Int64 UserId)
		{
			try
			{
				List<Events> lt = new List<Events>();
		...
		/// <returns>List<Events></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<Events> SelectBy_UserId_Pages(Int64 UserId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<Events> lt = new List<Events>();
