...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class TrackUsersPlacesDB : Persistent
	{
		#region ATRIBUTOS
		...
		public TrackUsersPlacesModel()
		{
		
		}		

		public TrackUsersPlacesModel(DBWork banco):base(banco)
		{
		...
		*/
		...
		public TrackUsersPlacesModel Load(Int64 UserId, Int64 PlaceId)
		{
			try
			{				
		...
		/// <returns>List<TrackUsersPlaces></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersPlacesModel> SelectBy_UserId(Int64 UserId)
		{
			try
			{
				List<TrackUsersPlacesModel> lt = new List<TrackUsersPlacesModel>();
				DataTable dt = new DataTable();
				...
				for (int i=0;i<dt.Rows.Count;i++)
				{
					TrackUsersPlacesModel obj = new TrackUsersPlacesModel();
		...
		/// <returns>List<TrackUsersPlaces></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersPlacesModel> SelectBy_UserId_Pages(Int64 UserId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<TrackUsersPlacesModel> lt = new List<TrackUsersPlacesModel>();
		...
		/// <returns>List<TrackUsersPlaces></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersPlacesModel> SelectBy_PlaceId(Int64 PlaceId)
		{
			try
			{
				List<TrackUsersPlacesModel> lt = new List<TrackUsersPlacesModel>();
		...
		/// <returns>List<TrackUsersPlaces></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<TrackUsersPlacesModel> SelectBy_PlaceId_Pages(Int64 PlaceId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<TrackUsersPlacesModel> lt = new List<TrackUsersPlacesModel>();
