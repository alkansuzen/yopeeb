...
namespace Beepoy.Library
{
	...
	/// </summary>
	public class EventsTags : Persistent
	{
		#region ATRIBUTOS
		...
		*/
		...
		public EventsTags Load(Int64 TagId, Int64 EventId)
		{
			try
			{				
		...
		/// <returns>List<EventsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<EventsTags> SelectBy_TagId(Int64 TagId)
		{
			try
			{
				List<EventsTags> lt = new List<EventsTags>();
		...
		/// <returns>List<EventsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<EventsTags> SelectBy_TagId_Pages(Int64 TagId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<EventsTags> lt = new List<EventsTags>();
		...
		/// <returns>List<EventsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<EventsTags> SelectBy_EventId(Int64 EventId)
		{
			try
			{
				List<EventsTags> lt = new List<EventsTags>();
		...
		/// <returns>List<EventsTags></returns>
		/// <exception cref="System.Data.Common.DbException"></exception>
		public List<EventsTags> SelectBy_EventId_Pages(Int64 EventId, int currentPage, int pageSize, out int totalDeRegistros)
		{
			try
			{
				List<EventsTags> lt = new List<EventsTags>();
